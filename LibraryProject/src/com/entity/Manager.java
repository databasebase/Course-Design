...
public class Manager {
	...
	public String getManager_cardid() {
		return manager_cardid;
	}
	public void setManager_cardid(String manager_cardid) {
		this.manager_cardid = manager_cardid;
	}
